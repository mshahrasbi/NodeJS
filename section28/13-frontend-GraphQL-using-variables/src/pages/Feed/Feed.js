...
class Feed extends Component {
  ...
  componentDidMount() {
    console.log('[Feed] componentDidMount:props: ', this.props);
    ...
    fetch('http://localhost:8080/graphql', {
      ...
      .then(resData => {
        console.log('[Feed] componentDidMount:resData ', resData);
  ...
  finishEditHandler = postData => {
    ...
    fetch('http://localhost:8080/post-image', {
      ...
      .then( fileResData => {
        ...
        const imageUrl = 'images/person.png';// fileResData.filePath || 'undefined'; // todo figure out why erros out in Server side... not liking the path format
