...
class Feed extends Component {
  ...
  loadPosts = direction => {
    ...
    fetch('http://localhost:8080/graphql', {
      ...
      .then(resData => {
        console.log('[loadPosts] resData: ', resData);
        if (resData.errors) {
  ...
  finishEditHandler = postData => {
    ...
    fetch('http://localhost:8080/post-image', {
      ...
      .then( fileResData => {
        ...
        const imageUrl = 'images';// fileResData.filePath; // todo figure out why erros out in Server side... not liking the path format
